...
void bind_sidekiq_rx(py::module& m)
{
    ...
    py::class_<sidekiq_rx, gr::sync_block, gr::block, gr::basic_block,
        ...
        .def("set_rx_gain_mode",&sidekiq_rx::set_rx_gain_mode,       
            py::arg("value"),
        ...
        .def("set_rx_gain_index",&sidekiq_rx::set_rx_gain_index,       
            py::arg("value"),
            D(sidekiq_rx,set_rx_gain_index)
        )


        
        .def("set_rx_cal_mode",&sidekiq_rx::set_rx_cal_mode,       
            py::arg("value"),
        ...
        .def("set_rx_cal_type",&sidekiq_rx::set_rx_cal_type,       
            py::arg("value"),
        ...
        .def("run_rx_cal",&sidekiq_rx::run_rx_cal,       
            py::arg("value"),
